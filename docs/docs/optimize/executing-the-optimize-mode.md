...
Jesse outputs the optimization results (DNA, hyperparameters, fitness...) into a CSV file (tab delimiter). You may open this CSV file with Excel, Google sheets, or whatever tool you like to analyze the optimization.
