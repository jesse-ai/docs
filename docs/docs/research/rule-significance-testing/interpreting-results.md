...
|---------|----------------|--------|
| p < 0.01 | Highly significant — very unlikely to be due to chance | ★★ |
| p < 0.05 | Significant — unlikely to be due to chance | ★ |
...
### Not significant result (p ≥ 0.05)

Fail to reject H₀. The rule's historical performance is consistent with chance. Before spending time on a full backtest, revisit the entry logic:
...
============================================================
  ...
  p-value           : 0.0180   →  SIGNIFICANT (p < 0.05) ★
============================================================
```
...
============================================================
  ...
  p-value           : 0.7990   →  not significant (p ≥ 0.05)
============================================================
```
